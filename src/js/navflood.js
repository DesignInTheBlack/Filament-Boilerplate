export function triggerNavFlood({
  selector = 'canvas.-navfluid',
  splatOptions = {}
} = {}) {
  ...
  canvases.forEach(canvas => {
    if (!canvas.dataset.navfloodInit) {
      createFluidSimulation(canvas);
      canvas.dataset.navfloodInit = 'true';
    }

    autoSplatFromCenter(canvas, splatOptions);
  });
}
