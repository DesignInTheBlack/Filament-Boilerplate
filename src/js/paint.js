...
//         vec2 p = vUv - point.xy;
//         p.x *= aspectRatio;
//         vec3 splat = exp(-dot(p, p) / radius) * color *0.75;
//         vec3 base = texture2D(uTarget, vUv).xyz;
//         vec3 result = base + splat;
// float brightness = dot(result.rgb, vec3(0.299, 0.587, 0.114));
// gl_FragColor = vec4(result, brightness); // alpha proportional to brightness
//     }
// `);
...
//   const baseColor = [0.929, 0.957, 0.957]; // Approx. #EDF4F4
...
let config = {
  TEXTURE_DOWNSAMPLE: 2,
  DENSITY_DISSIPATION: 0.99, // Keep this for stability
  VELOCITY_DISSIPATION: 0.997,
  PRESSURE_DISSIPATION: 0.8,
  PRESSURE_ITERATIONS: 32,
...
const palette = [
  [0.659, 0.678, 0.435], // #A8AD6F muted olive
  [0.000, 0.678, 0.702], // #00ADB3 teal
  [0.047, 0.094, 0.082], // #0C1815 deep forest
  [0.886, 0.878, 0.882]  // #E2E0E1 light mist
];
